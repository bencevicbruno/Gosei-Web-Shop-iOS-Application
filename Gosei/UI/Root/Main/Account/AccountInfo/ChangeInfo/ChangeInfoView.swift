...
private extension ChangeInfoView {
    ...
    var adressField: some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            textField($viewModel.adress, hint: "Enter your adress here", color: .black)
        }
    }
    ...
    var birthdayFields: some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            HStack {
                textField($viewModel.birthDay, hint: "dd.", color: viewModel.isBirthdayDateValid ? .black : .goseiRed)
                    .frame(width: 50)
                
                textField($viewModel.birthDay, hint: "mm.", color: viewModel.isBirthdayDateValid ? .black : .goseiRed)
                    .frame(width: 50)
                
                textField($viewModel.birthDay, hint: "yyyy.", color: viewModel.isBirthdayDateValid ? .black : .goseiRed)
                    .frame(width: 70)
            }
