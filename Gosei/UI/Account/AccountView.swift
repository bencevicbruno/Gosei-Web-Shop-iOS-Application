    ...
    var body: some View {
        VStack {
            ...
            VStack {
                ...
                button(Localizable.account_info.localized) { [weak viewModel] in
                    viewModel?.accountInfoTapped()
                }
                
                button(Localizable.my_orders.localized) { [weak viewModel] in
                    viewModel?.goToMyOrders?()
                }
                
                button(Localizable.language.localized) { [weak viewModel] in
                    viewModel?.goToLanguages?()
                }
                
                button(Localizable.help.localized) { [weak viewModel] in
...
private extension AccountView {
    ...
    var nightModeSwitch: some View {
        HStack {
            Text(Localizable.light.localized)
            ...
            Text(Localizable.dark.localized)
                .contentShape(Rectangle())
                .onTapGesture { [weak viewModel] in
